...
const StudentEnquiry = () => {
  ...
  const [isSending, setIsSending] = useState(false); // State to track if sending request
  ...
  const handleSendMessage = async () => {
    ...
    setIsSending(true); // Start sending, show the loader
    ...
    try {
      ...
      setIsSending(false); // Stop sending, hide the loader
    }
  };
    ...
    <div className="student-enquiry">
      ...
      <div>
        <button className="send-btn" onClick={handleSendMessage}>
          {isSending ? <Loader/> : "Send Enquiry To Professor"}
        </button>
      </div>
      <div>
